...
def process_chat_message(message: str, user_data: dict):
    ...
    # Respuestas del bot basadas en el paso
    if paso == 1:
...
async def run_exhaustive_tests():
    ...
    # Generar vulnerabilidades encontradas (algunas aleatorias)
    ...
    # Recomendaciones de IA basadas en el análisis
    ai_recommendations = [
    ...
    # Seleccionar recomendaciones relevantes
